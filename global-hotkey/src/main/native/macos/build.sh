#!/bin/bash
# Compiles nucleus_global_hotkey_macos.m into per-architecture dylibs (arm64 + x86_64).
...
SRC="$SCRIPT_DIR/nucleus_global_hotkey_macos.m"
...
LIB_NAME="libnucleus_global_hotkey.dylib"
